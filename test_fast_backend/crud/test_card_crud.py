...
class TestCardCrud:
    ...
    async def test_create_card(self, initialize_database, card_data):
    ...
    @pytest.mark.parametrize("card_data", SAMPLE_CARDS)
    async def test_get_card(self, initialize_database, card_factory, card_data):
    ...
    async def test_get_card_not_found(self, initialize_database):
    ...
    async def test_get_all_cards(self, initialize_database, card_factory):
    ...
    async def test_update_card_not_found(self, initialize_database):
    ...
    async def test_delete_card_not_found(self, initialize_database):
