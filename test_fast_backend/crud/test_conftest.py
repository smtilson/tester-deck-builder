...
from fast_backend.app.schemas import DeckResponse
...
@pytest.mark.asyncio
class TestFixtures:
    async def test_single_user_fixture(self, single_user, all_test_data):
    ...
    async def test_single_game_fixture(self, single_game, all_test_data):
    ...
    async def test_single_card_fixture(self, single_card, all_test_data):
    ...
    async def test_single_deck_no_cards_fixture(self, single_deck_no_cards, all_test_data):
    ...
    async def test_setup_users_fixture(self, setup_users, all_test_data):
