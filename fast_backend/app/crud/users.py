...
class UserRepo:
    ...
    @staticmethod
    async def get_user(user_id: UUID) -> Optional[UserRead]:
        """
    ...
    async def get_all_users() -> list[UserRead]:
        ...
        return [UserRead.model_validate(user) for user in user_objs]

    @staticmethod
    async def update_user(user_id: UUID, user_data: UserUpdate) -> Optional[UserRead]:
        """
        Update a user.
    ...
    @staticmethod
    async def set_admin_status(user_id: UUID, is_admin: bool) -> Optional[UserRead]:
        """
