...
from app.schemas.cards import CardInDB
from app.schemas.deck_cards import DeckCardCreate
from app.models.deck_cards import DeckCard as DeckCardModel
from app.models.decks import Deck as DeckModel

from app.exceptions.cards import CardsNotFound
from app.exceptions.decks import DeckNotFound, DeckException
...
class DeckCardService:
    ...
    async def process_add_cards_request(cards_to_add: list[DeckCardCreate]):
        ...
        processed_data = [{"deck_id": deck_id, "card_id": card[0], "quantity": card[1]} for card in card_data]
