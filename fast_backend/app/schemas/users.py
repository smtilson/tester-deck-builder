...
from uuid import UUID # For UUID primary key
...
class UserRead(schemas.BaseUser[UUID]):
    ...
    Inherits from BaseUser and specifies UUID as the ID type.
    """
    username: str
    email: str
...
class UserCreate(schemas.BaseUserCreate):
    ...
    is_admin: Optional[bool] = False # Allow setting admin status on creation if desired
    oauth_accounts: Optional[list] = Field(default_factory=list)
