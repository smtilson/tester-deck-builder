...
This is a backend for a card management system. The idea is that it be useable by playtesters and game developers alike.
...
DATABASE_URI=postgres://postgres:password@localhost/fast_backend
DEFAULT_FROM_EMAIL=fast-backend@gmail.com
